...
return [
    ...
    'password' => 'As senhas devem ter pelo menos 6 (seis) caracteres e corresponder à confirmação.',
    'reset' => 'Sua senha foi alterada!',
    'sent' => 'Enviamos um e-mail com o link de redefinição de senha!',
    'token' => 'Este token de redefinição de senha é inválido.',
    'UsersTableSeeder' => "Não conseguimos encontrar um usuário com esse endereço de e-mail.",
    /*
    |--------------------------------------------------------------------------
